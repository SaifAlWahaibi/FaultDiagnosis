...
*LGS-CNN and CNN Models 1-5 are trained and validated on the same dataset /n
**LGS-CNN and CNN Models 1-5 have a similar number of trainable parameters with the CNN madels having slightly more /n
